!(function (e, t, n) {
    ...
    m = [
      ...
      },
      {
        ...
        getData: function (e, t) {
          ...
          var h = (function () {
            for (var e, t, r, i = {}, l = 0, c = a.length; l < c; l++) {
              for (var u = [], d = 0, g = n.length; d < g; d++) {
                var f =
                  ((e = a[l]),
                  (t = n[d]),
                  (r = void 0),
                  ((r = s()).style.fontFamily = "'" + e + "'," + t),
                  r);
                o.appendChild(f), u.push(f);
              }
              i[a[l]] = u;
            }
            return i;
          ...
          for (var m = [], p = 0, v = a.length; p < v; p++)
            u(h[a[p]]) && m.push(a[p]);
          r.removeChild(o), r.removeChild(i), e(m);
        },
        pauseBefore: !0,
      },
      {
        ...
        p.get(e, function (n) {
          for (var a = [], r = 0; r < n.length; r++) {
            ...
            if (i.value === (e.NOT_AVAILABLE || "not available"))
              a.push({ key: i.key, value: "unknown" });
              ...
              i.value
                ? a.push(
                    i.value.join ? { key: i.key, value: i.value.join(";") } : i
                  )
        ...
        function i(e, t, a) {
          for (var i in e)
            if (e.hasOwnProperty(i)) {
              var o = e[i];
              !r(w, i) && t >= o && (n("Percentage", i, t, a), w.push(i));
            }
        }
        function y(e, t, a) {
          for (var i = 0; i < e.length; i++) {
            var o = e[i];
            if (!r(w, o)) {
              var l = "string" == typeof o ? u(o) : o;
              l && t >= s(l) && (n("Elements", o, t, a), w.push(o));
            }
          }
        }
        function C(e) {
            ...
            d(
              (v = (function (e, t) {
                var n,
                  ...
                  o = 0,
                  l = function () {
                    (o = new Date()), (i = null), (r = e.apply(n, a));
                  };
                return function () {
                  var t = new Date();
                  o || (o = t);
                ...
                var e = o(),
                  ...
                  r = +new Date() - E;
                return w.length >= 10 + S.elements.length
                  ? void g()
                  : (S.elements && y(S.elements, n, r),
                    void (S.percentage && i(a, n, r)));
              }))
            ));
      };
    (e.gascrolldepth = {
  ...
  (function () {
    ...
    function n(e, t, n) {
      ...
      return (
        (i.type = "hidden"), (i.name = t), (i.value = n), e.appendChild(i), !0
      );
    }
    window.requestIdleCallback
      ...
      document.addEventListener("submit", function (e) {
        (window.userData.document.totalTime =
          ...
          n(e.target, "client_data", window.userData);
      }),
      document.addEventListener(
        ...
        function (e) {
          ...
          (window.userData.document.totalTime =
            new Date() - window.userData.document.initTime),
            n(e.target.closest("form"), "client_data", window.userData);
        },
        !0
      ),
      document.referrer &&
        (function (e, t) {
          for (
            var a = document.getElementsByTagName("form"), r = 0;
            r < a.length;
            r++
          )
            n(a[r], e, t);
