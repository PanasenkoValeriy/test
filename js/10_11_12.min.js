!(function (a, b) {
  ...
  a.defineLocale("bn", {
    months:
      "জানুয়ারী_ফেব্রুয়ারি_মার্চ_এপ্রিল_মে_জুন_জুলাই_আগস্ট_সেপ্টেম্বর_অক্টোবর_নভেম্বর_ডিসেম্বর".split(
        "_"
      ),
      ...
      relativeTime: {
        ...
        past: function (a) {
          return /(წამი|წუთი|საათი|დღე|თვე)/.test(a)
            ? a.replace(/(ი|ე)$/, "ის უკან")
            : /წელი/.test(a)
            ? a.replace(/წელი$/, "წლის უკან")
            : void 0;
        },
        s: "რამდენიმე წამი",
        m: "წუთი",
  ...
  a.defineLocale("kn", {
    ...
    monthsShort:
      "ಜನ_ಫೆಬ್ರ_ಮಾರ್ಚ್_ಏಪ್ರಿಲ್_ಮೇ_ಜೂನ್_ಜುಲೈ_ಆಗಸ್ಟ್_ಸೆಪ್ಟೆಂಬ_ಅಕ್ಟೋಬ_ನವೆಂಬ_ಡಿಸೆಂಬ".split(
        "_"
      ),
    monthsParseExact: !0,
  ...
  a.defineLocale("ta", {
    ...
    a.defineLocale("te", {
      months:
        "జనవరి_ఫిబ్రవరి_మార్చి_ఏప్రిల్_మే_జూన్_జూలై_ఆగస్టు_సెప్టెంబర్_అక్టోబర్_నవంబర్_డిసెంబర్".split(
          "_"
        ),
      monthsShort:
...
!(function (t) {
  ...
  (function (t) {
    ...
    function C(t, e) {
      ...
      return (
        !((!r && !e) || "true" !== t.getAttribute(h)) &&
        (t.removeAttribute(h),
        (t.value = t.value.replace(t.getAttribute(m), "")),
        (t.className = t.className.replace(b, "")),
        (e = t.getAttribute(E)),
        0 <= parseInt(e, 10) &&
          (t.setAttribute("maxLength", e), t.removeAttribute(E)),
        (e = t.getAttribute(f)) && (t.type = e),
        !0)
      );
    }
    function k(t) {
    ...
    function I(t, e) {
      ...
      if (t && t.getAttribute(m)) e(t);
        ...
        for (
          a = t ? t.getElementsByTagName("input") : l,
            n = t ? t.getElementsByTagName("textarea") : o,
            i = 0,
            u = (r = a ? a.length : 0) + (n ? n.length : 0);
          i < u;
          i++
        )
          e(i < r ? a[i] : n[i - r]);
    ...
    function V(t) {
      var e, r, a, n, u, i;
      t.form &&
        ("string" == typeof (g = t.form) && (g = document.getElementById(g)),
        g.getAttribute(A) ||
          (S.addEventListener(
            g,
            "submit",
        ...
        S.addEventListener(
          ...
          ((r = t),
          function () {
            c && r.value === r.getAttribute(m) && "true" === r.getAttribute(h)
              ? S.moveCaret(r, 0)
              : C(r);
          })
        ),
        ...
        c &&
          (S.addEventListener(
            ...
            function (t) {
              if (
                ((s = i.value),
                "true" === i.getAttribute(h) &&
                  s === i.getAttribute(m) &&
                  S.inArray(v, t.keyCode))
              )
          ...
          S.addEventListener(
            ...
            function () {
              n === B() &&
                n.value === n.getAttribute(m) &&
                "true" === n.getAttribute(h) &&
                S.moveCaret(n, 0);
            })
          )),
        t.setAttribute(y, "true"),
        t.setAttribute(m, d),
        (!c && t === B()) || k(t);
    }
    if (((N.nativeSupport = void 0 !== x.placeholder), !N.nativeSupport)) {
      for (
        l = document.getElementsByTagName("input"),
          ...
          c = "false" === T.getAttribute("data-placeholder-focus"),
          e = "false" !== T.getAttribute("data-placeholder-live"),
          (x = document.createElement("style")).type = "text/css",
          T = document.createTextNode("." + p + " { color:#ccc; }"),
          x.styleSheet
        ...
        (a = u < l.length ? l[u] : o[u - l.length]),
          (d = (d = a.attributes.placeholder) && d.nodeValue) &&
            S.inArray(i, a.type) &&
            V(a);
      r = setInterval(function () {
        for (u = 0, n = l.length + o.length; u < n; u++)
          (a = u < l.length ? l[u] : o[u - l.length]),
            (d = a.attributes.placeholder)
              ? (d = d.nodeValue) &&
                S.inArray(i, a.type) &&
                (a.getAttribute(y) || V(a),
                (d === a.getAttribute(m) &&
                  ("password" !== a.type || a.getAttribute(f))) ||
                  ("password" === a.type &&
                    !a.getAttribute(f) &&
                    S.changeType(a, "text") &&
                    a.setAttribute(f, "password"),
                  a.value === a.getAttribute(m) && (a.value = d),
                  a.setAttribute(m, d)))
              : a.getAttribute(h) && (C(a), a.removeAttribute(m));
        e || clearInterval(r);
      }, 100);
    }
    S.addEventListener(t, "beforeunload", function () {
      ...
      (N.disable = N.nativeSupport ? w : R),
      (N.enable = N.nativeSupport
        ? w
        : function (t) {
            I(t, k);
          });
...
var adcValid;
"object" !== _typeof(adcValid) && (adcValid = {}),
  (adcValid.errorMes = {
    settings: { button: [], message: "js_errorMessage" },
    remove: function () {
      $(
        "." + this.settings.message + ", ." + this.settings.message + "2"
      ).remove();
    },
    mes: function (e, r) {
      var t,
      ...
      if (!a.length)
        return console.error("Not an item to display an error", a), !1;
      (s =
        o.body === o.add
          ? (o.add.add("html"), (i = a.offset().left), a.offset().top)
          : ((i = a.offset().left - o.add.offset().left),
            a.offset().top - o.add.offset().top + o.add.scrollTop())),
        o.add.animate({ scrollTop: s - 50 }, 0, function () {
          (t =
            "left: " +
            i +
            "px;top: " +
            (s - 36) +
            "px;background-color: #e74c3c;border-radius: 5px;border: 1px dashed black;color: #fff;font-family: Arial, 'Nimbus Sans L', Helvetica, sans-serif;font-size: 14px;margin: 3px 0 0 0px;padding: 6px 5px 5px;position: absolute;display: block;z-index: 9999"),
            o.remove(),
            o.add.append(
              '<div class="' +
                o.settings.message +
    ...
    init: function () {
      ...
      (i.window = $(window)),
        (i.body = $("body")),
        (i.add = i.body),
        (i.click = $("input, textarea").add(i.body)),
        i.click.on("touchend click", function (e) {
          for (var r = !0, t = 0; t < i.settings.button.length; t++)
            ($(e.target).closest("." + i.settings.button[t]).length ||
              e.target.classList.contains(i.settings.button[t])) &&
              (r = !1);
          r && i.remove();
        }),
        i.resize();
  ...
  (adcValid.validation = {
    ...
    partition: function (e, r, t, i) {
      var s = !1,
        o = "function" == typeof e.attr ? e : $(e),
        e = this.cleaning(o.val());
      if (((mes = r || defaults.get_locale_var("set_address")), e)) o.val(e);
      else if (
        ("object" === _typeof(t) ? void 0 !== t[i] && (s = t[i]) : (s = t), s)
      )
        return o.val(""), adcValid.errorMes.mes(o, mes), !1;
      return !0;
    },
    init: function (e, r) {
      var t,
        ...
        s = {
          ...
          erAddress: [
            "Invalid address, please, refill the form",
            "error_address",
          ],
      ...
      for (t in s)
        "object" === _typeof(defaults) &&
          s[t][1] &&
          (s[t][0] = defaults.get_locale_var(s[t][1]));
      if (
        ((i.button = "function" == typeof e.attr ? e : $(e)),
        (i.form = i.button.closest("form")),
        i.allForm || (i.allForm = $("form")),
        (i.input = {
          name: i.form.find('[name="name"]'),
          phone: i.form.find('[name="phone"]'),
          address: i.form.find('[name="address"]'),
          email: i.form.find('[name="email"]'),
        }),
        "2+" === i.input.name.attr("data-count-length") &&
          (i.settings.rename = i.settings.rename2),
        i.cleaning(i.input.name.val()))
      ) {
        if (i.settings.rename.test(i.cleaning(i.input.name.val()))) {
          if (i.input.phone.val() && i.input.phone.val().length) {
            if (
              !i.settings.rephone.test(i.input.phone.val()) ||
              i.input.phone.val().length < 6
            )
              return adcValid.errorMes.mes(i.input.phone, s.erPhone[0]), !1;
            if (
              i.input.address.length &&
              "" === i.cleaning(i.input.address.val()) &&
              i.input.address.is(":visible")
            )
              return adcValid.errorMes.mes(i.input.address, s.erAddress[0]), !1;
            if (
              i.input.email.length &&
              i.input.email.is(":visible") &&
              !i.settings.email.test(i.input.email.val())
            )
              return adcValid.errorMes.mes(i.input.email, s.erEmail[0]), !1;
            if ("object" === _typeof(r) && !r.length) {
              for (var o in ((i.fullAddress = []), r)) {
                var a = i.form.find('[name="' + o + '"]'),
                  n =
                    "street" === o
                      ? "notAddress"
                      : "house" === o
                ...
                if (a.length) {
                  if (
                    ...
                    (!i.cleaning(a.val()) ||
                      (i.settings[o] &&
                        !i.settings[o].test(i.cleaning(a.val()))))
                  )
                    return adcValid.errorMes.mes(a, s[n][0]), !1;
                } else if (
                  ((a = i.form.find("#" + o + '[type="checkbox"]')),
                  a.length && !a.prop("checked"))
                )
                  return adcValid.errorMes.mes(a, s[n][0]), !1;
                "checkbox" !== a.attr("type") &&
                  i.fullAddress.push(i.cleaning(a.val()));
              }
              i.allForm.find('[name="address"]').val(i.fullAddress.join(" "));
            }
            return adcValid.errorMes.remove(), !0;
          }
          return adcValid.errorMes.mes(i.input.phone, s.notPhone[0]), !1;
        }
        return adcValid.errorMes.mes(i.input.name, s.erName[0]), !1;
      }
      return adcValid.errorMes.mes(i.input.name, s.notName[0]), !1;
    },
  }),
  $().ready(function () {
    adcValid.errorMes.init(),
      ...
      $(".to_top").click(function (e) {
        return (
          e.preventDefault(), $("html,body").animate({ scrollTop: 0 }, 400), !1
        );
      });
    var e,
      r,
      t = $("input[name=ip_country]").val();
    t &&
      ((e = !1),
      $("select").each(function () {
        "country_code_selector" === this.id &&
          ($(this).change(function () {
            $("input[name=country_code]").val(this.value);
          }),
          $("#" + this.id + " option").each(function () {
            this.value === t && ((e = !0), (this.parentElement.value = t));
          }));
      }),
      e
        ...
        : (r = $("input[name=ip_country_name]").val()) &&
          $("select").each(function () {
            "country_code_selector" === $(this).attr("id") &&
              $(this).append(
                $("<option>", { value: t })
                  .text(r)
    ...
    var i = $("#country_code_selector").val();
    function s(e, r) {
      $(".js_errorMessage").remove(),
        jQuery('<div class="js_errorMessage">' + r + "</div>")
          .appendTo("body")
          .css({
            left: jQuery(e).offset().left,
            top: jQuery(e).offset().top - 30,
    ...
    i && $("input[name=country_code]").val(i),
      $(".only_number").on("keydown", function (e) {
        /^(?:46|8|9|27|187)$/.test(e.keyCode) ||
      ...
      $(".js_submit").click(function (e) {
        ...
        return (
          ...
          (n = {
            submit: function (r, t) {
              var i = {
                  country: r.find('[name="country_code"]'),
                  fio: r.find('[name="name"]'),
                  phone: r.find('[name="phone"]'),
                  lid: r.find('[name="lid"]'),
                  address: r.find('[name="address"]'),
                  house: r.find('[name="house"]'),
                  city: r.find('[name="city"]'),
                  email: r.find('[name="email"]'),
                  validate_address: r.find('[name="validate_address"]'),
                },
                s = {
                  method: "feedback",
                  name: i.fio.val(),
                  ...
                  city: i.city.val(),
                  validate_address: i.validate_address.val(),
                };
              jQuery(".js_errorMessage").remove();
              s.country.toLowerCase();
              var e = /^[\D+ ]*$/i;
              if (
                ("2+" == i.fio.attr("data-count-length") &&
                  (e = /^\D+\s[\D+\s*]+$/i),
                !s.name.length)
              )
                return n.errorMessage(
                  i.fio,
                  defaults.get_locale_var("set_fio")
                );
              if (!s.name.length || !e.test(s.name))
                return n.errorMessage(
                  i.fio,
                  defaults.get_locale_var("error_fio")
                );
              if (!s.phone || !s.phone.length)
                return n.errorMessage(
                  i.phone,
                  defaults.get_locale_var("set_phone")
                );
              if (!/^[0-9\-\+\(\) ]*$/i.test(s.phone) || s.phone.length < 6)
                return n.errorMessage(
                  i.phone,
                  defaults.get_locale_var("error_phone")
                );
              if (
                s.email &&
                s.email.length &&
                ...
                return n.errorMessage(
                  i.email,
                  defaults.get_locale_var("error_email")
                );
              if (
                i.address.length &&
                "none" !== $(i.address).css("display") &&
                "" === s.address
              )
                return n.errorMessage(
                  i.address,
                  defaults.get_locale_var("set_address")
                );
              if (
                i.city.length &&
                "none" !== $(i.city).css("display") &&
                "hidden" !== i.city.attr("type") &&
                "" === s.city
              )
                return n.errorMessage(
                  i.city,
                  defaults.get_locale_var("set_city")
                );
              if (
                i.house.length &&
                "none" !== $(i.house).css("display") &&
                "" === s.house
              )
                return n.errorMessage(
                  i.house,
                  defaults.get_locale_var("set_house")
                );
              if (
                i.validate_address &&
                "1" === s.validate_address &&
                i.address.length &&
                "none" !== $(i.address).css("display")
              ) {
                var o = {};
                return (
                  $.each(r.serializeArray(), function () {
                    void 0 !== o[this.name]
                  ...
                  $.post("/order/validate_address/", o)
                    ...
                    .fail(function () {
                      $(i.city).css("display", "inline-block"),
                        $(i.house).css("display", "inline-block");
                      var e = defaults.get_locale_var("error_address");
                      if (void 0 !== s.address)
                        return n.errorMessage(i.address, e);
                      showAnotherFormHint(e);
                    }),
                  !1
                );
              }
              if (t) t(r);
                ...
                $(a).hasClass("js_custom_validate") &&
                "function" == typeof adc_custom_validate
              ) {
                if (!adc_custom_validate(r)) return !1;
                r.submit();
              } else r.submit();
              return !1;
            },
            errorMessage: s,
          }).submit($(a).parents("form").first()),
          !1
        );
      }),
      ...
      $(".change-package-button").on("touchend, click", function () {
        var e = $(this).data("package-id");
        $('.change-package-selector [value="' + e + '"]').prop("selected", !0),
          set_package_prices(e);
      }),
      $(".change-package-selector").on("change", function () {
        set_package_prices($(this).val());
      }),
      ["model", "browser", "brand", "appname"].forEach(function (e) {
        window[e] =
          (function (e) {
            for (
              var r = window.location.search.substring(1).split("&"), t = 0;
              t < r.length;
              t++
            ) {
              var i = r[t].split("=");
      ...
      $("input[name=name]").on("touchend, click", function () {
        if ("" != name_hint) return s(this, name_hint), !1;
      }),
      $("input[name=phone]").on("touchend, click", function () {
        if ("" != phone_hint) return s(this, phone_hint), !1;
      }),
      ...
      checkTimeZone(),
      setBrowser(),
      "undefined" != typeof site_title && $("title").text(site_title),
      window.lang_locale && window.lang_locale.toLowerCase() in defaults.locale
        ? (defaults._locale = window.lang_locale.toLowerCase())
        : (defaults._locale = "en");
  });
var defaults = {
  get_locale_var: function (e) {
    var r = this._locale.toLowerCase();
    return (
      void 0 !== this.locale[r][e] ? this.locale[r] : this.locale[this._locale]
    )[e];
  },
  locale: {
    ru: {
      ...
      exit_text:
        "Вы точно хотите закрыть вкладку? До завершения заказа осталось нажать одну кнопку!",
    },
    hi: {
      ...
      exit_text:
        "क्या आप सुनिश्चित रूप से छोड़ना चाहते हैं? आप अपने आर्डर से बस एक चरण की दूरी पर हैं",
    },
    id: {
      ...
      exit_text:
        "Apakah Anda yakin Anda ingin meninggalkan laman ini? Hanya tinggal satu langkah lagi untuk menyelesaikan pesanan Anda!",
    },
    ms: {
      ...
      exit_text:
        "Adakah anda pasti anda ingin keluar? Hanya tinggal satu langkah lagi daripada pesanan anda!",
    },
    bg: {
      ...
      exit_text:
        "Сигурни ли сте че искате да затворите раздел? До приключване на поръчката кликнете с левия бутон един бутон!",
    },
    ro: {
      ...
      exit_text:
        "Sunteți sigur că doriți să închideți o filă? Până la finalizarea comenzii stânga faceți clic pe un buton!",
    },
    br: {
      ...
      exit_text:
        "Tem certeza de que quer fechar uma guia? Até a conclusão da ordem esquerda clique em um botão!",
    },
    hu: {
      ...
      exit_text:
        "Biztos benne, hogy be akarja zárni a lapra? Befejezéséig a rendelés bal gombbal egy gombot!",
    },
    tr: {
      ...
      exit_text:
        "Sayfamızı kapatmak istediniz. Eminmisiniz? Sipariş etmek icin son tıklama lazım!",
    },
    pl: {
    ...
    es: {
      ...
      exit_text:
        "¿De verdad quiere cerrar la pestana? ¡Para terminar su pedido solo queda presionar el botón!",
    },
    cl: {
      set_country: "No escogió un país",
      set_house: "House is a required field",
    ...
    nl: {
      ...
      exit_text:
        "Weet je zekerdat je het tabblad wilt sluiten? Nog maar één knop teklikken om je bestellingafteronden!",
    },
    pt: {
      ...
      exit_text:
        "Tem a certeza de que quer sair? Está apenas a um passo da sua encomenda!",
    },
    zh: {
      set_country: "你沒有選擇國家",
      set_house: "House is a required field",
    ...
    km: {
      ...
      exit_text:
        "តើអ្នកពិតជាចង់ចាកចេញមែនឬទេ? នៅសល់តែមួយជំហានទៀតអ្នកនឹងបញ្ជាទិញបានហើយ!",
    },
    nb: {
      ...
      exit_text:
        "Er du sikker på at du vil forlate siden? Du er bare et steg unna din ordre!",
    },
    nn: {
      set_country: "Du valgte ikke land",
      set_house: "House is a required field",
    ...
    ur: {
      ...
      exit_text:
        "کیا آپ اس صفحے سے جانا چاہتے ہیں؟ آپ اپنا آرڈر بک کرانے سے صرف ایک کلک دوری پر ہیں ",
    },
    fil: {
      ...
      exit_text:
        "Sigurado ka bang gusto mong umalis? Ikaw ay isang hakbang nalang mula sa iyong order!",
    },
    ar: {
      ...
      exit_text:
        "هل أنت متأكد أنك تريد أن تغادر؟ كنت للتو في خطوة واحدة من النظام الخاص بك!",
    },
    vi: {
      ...
      exit_text:
        "Bạn có chắc muốn rời đi không? Chỉ còn còn một bước đặt hàng nữa thôi!",
    },
    ng: {
      set_country: "Select country",
      set_house: "House is a required field",
    ...
    rs: {
      ...
      exit_text:
        "Da li ste sigurni da želite da zatvorite karticu ? Pre završetka naloga ostaje jedan taster pritisnuti!",
    },
    fr: {
      ...
      exit_text:
        "Êtes-vous sûr de fermer l'onglet ? Il vous reste de cliquer sur un seul bouton pour passer la commande !",
    },
    it: {
      ...
      exit_text:
        "Sicuro di chiudere la pagina? Per completare l'ordine basta solo premere il bottone!",
    },
    de: {
      ...
      exit_text:
        "Wirklich diesen Tab schließen? Bis Bestellungsabnahme bleibt nur ein Klick!",
    ...
    cs: {
      ...
      set_city: "City is a required field",
      exit_text:
        "Jistě chcete uzavřít stránku? Abyste ukončil zadání objednávky, náleží stlačit jedno tlačítko!",
    ...
    cn: {
      ...
      exit_text:
        "Do you really want to close the tab? Before an order completion  you should press only 1 button!",
    },
    sk: {
      ...
      exit_text:
        "Ste istí, že chcete zatvoriť kartu? Pre dokončenie objednávky zostalo potrebné jedné kliknutie!",
    ...
    th: {
      ...
      exit_text:
        "คุณแน่ใจไหมว่าจะออกจากหน้านี้ การสั่งซื้อของคุณเหลืออีกเพียงขั้นตอนเดียวเท่านั้น!",
      set_comment: "Povedzte niečo o svojom probléme",
      set_holder_name: "Vyplňte meno kandidáta",
      set_nomin: "Vyplňte nomináciu",
    },
    gr: {
      ...
      set_city: "City is a required field",
      error_phone:
        "Λάθος αριθμός τηλεφώνου! Παρακαλώ εισάγετε τον αριθμό του κινητού σας τηλεφώνου ξεκινώντας με 69",
    },
    ko: {
      ...
      exit_text:
        "정말 이 페이지에서 나오시겠습니까? 주문까지 오직 한 단계만 남았습니다!",
    },
  },
};
function set_package_prices(e) {
  var r, t, i;
  void 0 !== package_prices[e] &&
    ((r = +package_prices[e].price),
    (t = +package_prices[e].old_price),
    (i = +package_prices[e].shipment_price),
    $(".js_new_price").each(function () {
      $(this).is("input") ? $(this).val(r) : $(this).text(r);
    }),
    $(".js_old_price").each(function () {
      $(this).is("input") ? $(this).val(t) : $(this).text(t);
    }),
    $(".js_full_price").each(function () {
      $(this).is("input") ? $(this).val(r + i) : $(this).text(r + i);
    }),
    $(".js_delivery_price").each(function () {
      $(this).is("input") ? $(this).val(i) : $(this).text(i);
    }),
...
function checkTimeZone() {
  ...
  $("form").append('<input type="hidden" name="time_zone" value="' + e + '">'),
    $("form").append(
      '<input type="hidden" name="cc_combo_tz_name" value="' + r + '">'
    );
}
function setBrowser() {
  "undefined" != typeof ua &&
    $("form").append(
      '<input type="hidden" name="bw" value="' + ua.browser.name + '">'
    );
}
function sendPhoneOrder(e) {
  e = $(e).serializeArray();
  e.push({
    name: "uri_params",
...
function showLoader() {
  ...
  e = {
    ...
    height: "100%",
    background:
      "url(/!common_files/images/loader.gif) center center rgba(0,0,0,0.5) no-repeat",
  };
  $("#loader-block").css(e),
    $("#loader-block").animate({ opacity: 0 }, 2e4, function () {
      hideLoader();
    });
}
function hideLoader() {
...
function sendOrderData(r, t) {
  $.post("/order/create/", r, function (e) {
    if (
      ($('input[name="esub"]').val(r.esub),
      r.pixel_code && $("body").append(r.pixel_code),
      void 0 !== t)
    )
      return t();
  });
