!(function (s, m) {
  ...
  (s.cookie = function (e, a, t) {
    ...
    if (
      1 < arguments.length &&
      (!/Object/.test(Object.prototype.toString.call(a)) || null == a)
    )
      return (
        (t = s.extend({}, s.cookie.defaults, t)),
        null == a && (t.expires = -1),
        "number" == typeof t.expires &&
          ((r = t.expires),
          (n = t.expires = new Date()).setDate(n.getDate() + r)),
        (a = String(a)),
        (m.cookie = [
    ...
    for (
      var i,
        o = (t = a || s.cookie.defaults || {}).raw ? c : l,
        d = m.cookie.split("; "),
        u = 0;
      (i = d[u] && d[u].split("="));
      u++
...
var months_localized = {
  ...
  AdcLandDate = function (e) {
    var a = e.shift,
      ...
      e = void 0 === e ? 0 : e;
    (this._mode = r),
      (this._shift = ~["rdate"].indexOf(r) || isNaN(+a) || !a ? 0 : +a),
      (this._oldMethod = t),
      (this._euFormat = !!+n),
      (this._indexOfCollection = e),
...
function getLocalizedEntity(e, a) {
  ...
  var t = window.lang_locale || "en",
    a = {
      month: { dict: months_localized, method: "getMonth" },
      day: { dict: days_localized, method: "getDay" },
    }[a];
...
(AdcLandDate.prototype._compileDate = function (e) {
  var a =
    1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : new Date();
  (this._day = a),
    this._day.setDate(
      this._day.getDate() +
        (isNaN(+e) ? 0 : e) +
        (this._oldMethod && "dtimes" !== this._mode ? 1 : 0)
    );
}),
  (AdcLandDate.prototype._getLocalizedEntity = getLocalizedEntity),
  (AdcLandDate.prototype._formatNum = function (e) {
    return ("0" + e).slice(-2);
  }),
  (AdcLandDate.prototype.getDate = function () {
    ...
    return {
      ...
      rstart: function () {
        return (
          r._compileDate(r._shift, new Date(parseInt($.cookie("randDate")))),
          {
            day: r._formatNum(r._day.getDate()),
            month: r._formatNum(r._day.getMonth() + 1),
            year: r._day.getFullYear(),
      ...
      rdate: function (e) {
        ...
        return (
          31 <= e && (a = new Date(t.getTime() + 24946e5 + 15e4 * e)),
          r._compileDate(r._shift, a),
          {
            day: r._formatNum(r._day.getDate()),
            month: r._formatNum(r._day.getMonth() + 1),
            year: r._day.getFullYear(),
    ...
    var e = this,
      ...
      t = {
        dtime_nums: function () {
          return (
            e._euFormat
              ? "".concat(a.day, ".").concat(a.month, ".")
              : "".concat(a.month, ".").concat(a.day, ".")
          ).concat(a.year);
        },
        dtime: function () {
          return ""
  ...
  (AdcLandDate.init = function () {
    $.cookie("randDate") ||
      $.cookie("randDate", new Date().getTime() - 2592e6, { expires: 1 });
  }),
  AdcLandDate.init(),
  $(function () {
